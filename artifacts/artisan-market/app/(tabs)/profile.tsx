    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={[styles.content, { paddingTop: insets.top + 10, paddingBottom: insets.bottom + 30 }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.languageCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <View style={[styles.prefIcon, { backgroundColor: colors.secondary }]}><Ionicons name="globe-outline" size={18} color={colors.primary} /></View>
          <View style={{ flex: 1 }}><Text style={[styles.prefTitle, { color: colors.foreground }]}>App language</Text><Text style={[styles.prefText, { color: colors.mutedForeground }]}>Change every label and helper text</Text></View>
          <Pressable style={[styles.languageSelect, { backgroundColor: colors.secondary }]} onPress={() => setShowLanguageMenu((open) => !open)}><Text style={[styles.languageSelectText, { color: colors.foreground }]}>{languageLabels[language]}</Text><Feather name="chevron-down" size={14} color={colors.mutedForeground} /></Pressable>
        </View>
